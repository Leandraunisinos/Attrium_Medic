...
QUALQUER tecnologia de desenvolvimento de aplicativos móveis multiplataforma pode ser utilizada (Vue.js, React Native, Ionic, jQuery Mobile) .
Comprovar contato e a parceria com a entidade escolhida através de documentos, fotos ou vídeos (pode ser uma conversa via Whatsapp, email, etc).
O aplicativo não precisa ser necessariamente publicado em loja de aplicativos, apesar de ser desejado e incentivado.

Qual a solução de software para dispositivos móveis que pode auxiliar a entidade parceira? Como o aplicativo que o aluno se propõe a desenvolver pode auxiliar na solução de uma necessidade?
...
Nessa atividade acadêmica o desafio é avaliativo e permite uma reflexão prática dos conceitos no contexto profissional e social. Vamos lá?
